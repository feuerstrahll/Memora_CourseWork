          ...
          <div className="tech-grid">
            <div className="tech-item">
              ...
              <ul>
                ...
                <li><strong>Recharts</strong> - библиотека для визуализации данных и графиков</li>
              </ul>
            </div>
            <div className="tech-item">
              <h3>Backend</h3>
              <ul>
                ...
                <li><strong>JWT + Passport</strong> - аутентификация на основе токенов</li>
                <li><strong>Multer</strong> - загрузка файлов (PDF, DOCX)</li>
                <li><strong>class-validator</strong> - валидация входных данных</li>
              </ul>
            </div>
            <div className="tech-item">
              <h3>База данных</h3>
        ...
        <div className="about-section">
          ...
          <div className="features">
            <ul>
              ...
              <li>Система регистрации и авторизации пользователей с JWT-токенами</li>
              <li>Три уровня доступа: администратор, архивариус, исследователь</li>
              <li>Редактирование личного профиля (имя, род деятельности, место работы, должность)</li>
              <li>Расширенный поиск с фильтрацией по столбцам таблицы</li>
              <li>Сортировка записей по различным критериям (алфавит, даты, числовые значения)</li>
              <li>Загрузка и скачивание файлов документов (PDF, DOCX)</li>
              <li>Система заявок исследователей на просмотр и оцифровку</li>
              <li>Статистика и аналитика с визуализацией графиков</li>
            </ul>
          </div>
        </div>
      </div>
